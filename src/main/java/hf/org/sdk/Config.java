...
public class Config {
	...
	public static final String CHANNEL_CONFIG_PATH ="/home/user/workspace/github/fabric-samples/first-network/channel-artifacts/" +"channel.tx";
	
	public static final String ORG1_USR_BASE_PATH = "/home/user/workspace/github/fabric-samples/first-network/"+ "crypto-config" + File.separator + "peerOrganizations" + File.separator
			+ "org1.example.com" + File.separator + "users" + File.separator + "Admin@org1.example.com"
			+ File.separator + "msp";
	
	public static final String ORG2_USR_BASE_PATH ="/home/user/workspace/github/fabric-samples/first-network/"+ "crypto-config" + File.separator + "peerOrganizations" + File.separator
