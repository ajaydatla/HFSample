...
public class CreateChannel {
	...
	public static void main(String[] args) {
		try {
			...
			Collection<Orderer> orderersn = fabClient.getInstance().getChannel("mychannel").getOrderers();
			System.out.println(orderersn.size());
			
			System.exit(0);
			// Create a new channel
			Properties prop = new Properties();
			prop.setProperty("pemFile", "/home/user/workspace/github/fabric-samples/first-network/crypto-config/ordererOrganizations"
					+ "/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem");
			Orderer orderer = fabClient.getInstance().newOrderer(Config.ORDERER_NAME, Config.ORDERER_URL);

//			Channel mychannel1 = fabClient.getInstance().getChannel("mychannelc");
//			System.out.println(mychannel1.isInitialized());
//			System.exit(0);
