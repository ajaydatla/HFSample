...
public class Util {
	...
	public static void writeUserContext(UserContext userContext) throws Exception {
		String directoryPath = "/home/user/workspace/github/fabric-samples/basic-network/crypto-config/peerOrganizations/org1.example.com/users/" + userContext.getAffiliation();
